...
return [
    'cluster' => [
        ...
        // Минимальное количество узлов для работоспособности кластера
        // По умолчанию 6 из 10 (больше половины)
        'quorum' => (int) ($_ENV['REDIS_QUORUM'] ?? 6),
        ...
        'session' => [
            ...
            // Время жизни сессии в секундах (по умолчанию 24 минуты)
            'gc_maxlifetime' => (int) ($_ENV['REDIS_SESSION_LIFETIME'] ?? 1440),
